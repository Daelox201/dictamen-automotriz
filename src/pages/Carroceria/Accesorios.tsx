...
const inputs = [
  {
    name:"",
    inputs:[
      { label: "Bases de Espejos Laterales", nameElement: "basesEspejosLaterales" },
      { label: "Parrillas", nameElement: "parrillas" },
      { label: "Antenas", nameElement: "antenas" },
      { label: "Guardas y Protectores", nameElement: "guardasProtectores" },
      { label: "Insignias y Logotipos", nameElement: "insigniasLogotipos" }
    ]
  }
];
...
const Accesorios: React.FC = () => {
  const [dataForm, setDataForm] = useState<FormData>({
    ...
    select_basesEspejosLaterales:"",
    select_parrillas:"",
    select_antenas:"",
    select_guardasProtectores:"",
    select_insigniasLogotipos:"",

    au_basesEspejosLaterales: "0",
    or_basesEspejosLaterales: "0",
    rt_basesEspejosLaterales: "0",
    rc_basesEspejosLaterales: "0",
    ev_basesEspejosLaterales: "0",
    observaciones_basesEspejosLaterales: " ",
    ...
    rc_antenas: "0",
    ev_antenas: "0",
    observaciones_antenas: " ",

    au_guardasProtectores: "0",
    or_guardasProtectores: "0",
    rt_guardasProtectores: "0",
    rc_guardasProtectores: "0",
    ev_guardasProtectores: "0",
    observaciones_guardasProtectores: " ",

    au_insigniasLogotipos: "0",
    or_insigniasLogotipos: "0",
    rt_insigniasLogotipos: "0",
    rc_insigniasLogotipos: "0",
    ev_insigniasLogotipos: "0",
    observaciones_insigniasLogotipos: " ",
  });
  ...
  useEffect(()=>{
      if(dataDictamen){
          setDataForm({
              ...data,
              ...dataDictamen.carroceria_accesorios
          })
      }
  },[])

  useEffect(()=>{
    if(dataDictamen && dataDictamen.carroceria && dataDictamen.carroceria.carroceria_accesorios){
        setDataForm({
            ...dataForm,
            ...dataDictamen.carroceria.carroceria_accesorios
        })
    }
},[])
...
const handleInputSelect = (e: CustomEvent<InputChangeEventDetail>)=>{
  ...
  const handleForm = (e: FormEvent<HTMLFormElement>) =>{
      ...
      firebaseInstance.guardarCarroceriaAccesorios()
  }
