...
const inputs = [
  {
    name:"",
    inputs:[
      { label: "Luces Principales", nameElement: "lucesPrincipales" },
      { label: "Luces Intermitentes", nameElement: "lucesIntermitentes" },
      { label: "Direccionales", nameElement: "direccionales" },
      { label: "Freno", nameElement: "freno" },
      { label: "Estado Unidades", nameElement: "estadoUnidades" },
      { label: "Sujeciones", nameElement: "sujeciones" },
      { label: "Cableados y Conectores", nameElement: "cableadosConectores" },
      { label: "Reflejantes", nameElement: "reflejantes" }
    ]
  }
];
...
const Luces: React.FC = () => {
  const [dataForm, setDataForm] = useState<FormData>({
    ...
    select_lucesPrincipales:"",
    select_lucesIntermitentes:"",
    select_direccionales:"",
    select_freno:"",
    select_estadoUnidades:"",
    select_sujeciones:"",
    select_cableadosConectores:"",
    select_reflejantes:"",


    au_lucesPrincipales: "0",
    or_lucesPrincipales: "0",
    rt_lucesPrincipales: "0",
    rc_lucesPrincipales: "0",
    ev_lucesPrincipales: "0",
    observaciones_lucesPrincipales: " ",

    au_lucesIntermitentes: "0",
    or_lucesIntermitentes: "0",
    rt_lucesIntermitentes: "0",
    rc_lucesIntermitentes: "0",
    ev_lucesIntermitentes: "0",
    observaciones_lucesIntermitentes: " ",
  ...
  useEffect(()=>{
    if(dataDictamen && dataDictamen.carroceria && dataDictamen.carroceria.carroceria_luces){
        setDataForm({
            ...dataForm,
            ...dataDictamen.carroceria.carroceria_luces
        })
    }
},[])
...
const handleInputSelect = (e: CustomEvent<InputChangeEventDetail>)=>{
  ...
  const handleForm = (e: FormEvent<HTMLFormElement>) =>{
      ...
      firebaseInstance.guardarCarroceriaLuces()
  }
