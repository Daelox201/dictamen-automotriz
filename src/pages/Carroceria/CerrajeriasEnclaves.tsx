...
const data = [
  {
    ...
    nameForm: "Cerrajerias y Enclaves",
    nextSection: "Ruedas",
    prevSection: "Cristales y Ventanas",
    nextRoute: "ruedas",
    prevRoute: "cristalesVentanas",
  },
];
...
const inputs = [
  {name:"",
  inputs:[
    { label: "Chapas Puertas", nameElement: "chapasPuertas" },
    { label: "Chapas Capo y Cajuela", nameElement: "chapasCapoCajuela" },
    { label: "Seguros", nameElement: "seguros" },
    { label: "Enclave Aletillas", nameElement: "enclaveAletillas" },
    { label: "Enclave Capo y Cajuela", nameElement: "enclaveCapoCajuela" },
...
const CerrajeriasEnclaves: React.FC = () => {
  const [dataForm, setDataForm] = useState<FormData>({

    select_chapasPuertas:"",
    select_chapasCapoCajuela:"",
    select_seguros:"",
    select_enclaveAletillas:"",
    select_enclaveCapoCajuela:"",
    select_sujeciones:"",
    ...
    rc_chapasPuertas: "0",
    ev_chapasPuertas: "0",
    observaciones_chapasPuertas: " ",

    au_chapasCapoCajuela: "0",
    or_chapasCapoCajuela: "0",
    rt_chapasCapoCajuela: "0",
    rc_chapasCapoCajuela: "0",
    ev_chapasCapoCajuela: "0",
    observaciones_chapasCapoCajuela: " ",
    ...
    rc_seguros: "0",
    ev_seguros: "0",
    observaciones_seguros: " ",

    au_enclaveAletillas: "0",
    or_enclaveAletillas: "0",
    rt_enclaveAletillas: "0",
    rc_enclaveAletillas: "0",
    ev_enclaveAletillas: "0",
    observaciones_enclaveAletillas: " ",

    au_enclaveCapoCajuela: "0",
    or_enclaveCapoCajuela: "0",
    rt_enclaveCapoCajuela: "0",
    rc_enclaveCapoCajuela: "0",
    ev_enclaveCapoCajuela: "0",
    observaciones_enclaveCapoCajuela: " ",
  ...
  useEffect(()=>{
    if(dataDictamen && dataDictamen.carroceria && dataDictamen.carroceria.carroceria_cerrajerias_enclaves){
        setDataForm({
            ...dataForm,
            ...dataDictamen.carroceria.carroceria_cerrajerias_enclaves
        })
    }
},[])
...
const handleInputSelect = (e: CustomEvent<InputChangeEventDetail>)=>{
  ...
  const handleForm = (e: FormEvent<HTMLFormElement>) =>{
      ...
      firebaseInstance.guardarCarroceriaCarrajeriasEnclaves()
  }
...
export default CerrajeriasEnclaves;
