...
const data = [
  {
    ...
    nameForm: "Ruedas",
    nextSection: "Accesorios",
    prevSection: "Cerrajerias y Enclaves",
    nextRoute: "accesorios",
    prevRoute: "cerrajeriasEnclaves",
  },
];
...
const inputs = [{
  name:"",
  inputs:[
    { label: "Rines", nameElement: "rines" },
    { label: "Neumaticos", nameElement: "neumaticos" },
    { label: "Tapones", nameElement: "tapones" },
    { label: "Birlos", nameElement: "birlos" },
...
const Ruedas: React.FC = () => {
  ...
  useEffect(()=>{
    if(dataDictamen && dataDictamen.carroceria && dataDictamen.carroceria.carroceria_ruedas){
        setDataForm({
            ...dataForm,
            ...dataDictamen.carroceria.carroceria_ruedas
        })
    }
},[])
...
const handleInputSelect = (e: CustomEvent<InputChangeEventDetail>)=>{
  ...
  const handleForm = (e: FormEvent<HTMLFormElement>) =>{
      ...
      firebaseInstance.guardarCarroceriaRuedas()
  }
