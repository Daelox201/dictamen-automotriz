...
const data = [
  {
    ...
    nameForm: "Pintura",
    nextSection: "Lienzos y Partes de Colision",
    prevSection: "",
    nextRoute: "lienzosPartesColision",
    prevRoute: "",
  },
];
...
const inputs = [
  {
    name:"",
    inputs:[
      { label: "Color", nameElement: "color" },
      { label: "Estado (Aplicación)", nameElement: "estado" },
      { label: "Tonalidad de Lienzos", nameElement: "tonalidadLienzos" },
      { label: "Interior y Exterior", nameElement: "interiorExterior" }
    ]
  }
];
...
const Pintura: React.FC = () => {
  const [dataForm, setDataForm] = useState<FormData>({
    ...
    select_color:"",
    select_estado:"",
    select_tonalidadLienzos:"",
    select_interiorExterior:"",
    ...
    au_tonalidadLienzos: "0",
    or_tonalidadLienzos: "0",
    rt_tonalidadLienzos: "0",
    rc_tonalidadLienzos: "0",
    ev_tonalidadLienzos: "0",
    observaciones_tonalidadLienzos: "",
    au_interiorExterior: "0",
    or_interiorExterior: "0",
    rt_interiorExterior: "0",
    rc_interiorExterior: "0",
    ev_interiorExterior: "0",
    observaciones_interiorExterior: "",
  });
  ...
  useEffect(()=>{
    if(dataDictamen && dataDictamen.carroceria && dataDictamen.carroceria.carroceria_pintura){
        setDataForm({
            ...dataForm,
            ...dataDictamen.carroceria.carroceria_pintura
        })
    }
},[])
...
const handleInputSelect = (e: CustomEvent<InputChangeEventDetail>)=>{
  ...
  const handleForm = (e: FormEvent<HTMLFormElement>) =>{
      ...
      firebaseInstance.guardarCarroceriaPintura()
  }
