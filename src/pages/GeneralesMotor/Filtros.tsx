...
const data = [{
    ...
    nameForm:"Filtros", 
    nextSection:'Tapas y Depositos', 
    prevSection:'Tapones', 
    nextRoute:'tapasDepositos', 
    prevRoute:'tapones'
}]
...
const inputs = [
    {
        ...
        inputs:[
            ...
            {label:'Aire Habitaculo Pasajeros', nameElement:'aireHabitaculoPasajeros'},
        ]
    }
]
...
const Filtros:React.FC = () =>{
    ...
    const [dataForm, setDataForm] = useState({
        ...
        select_aceite:"",
        select_aireHabitaculoPasajeros:"",
        ...
        au_aireHabitaculoPasajeros:0,
        or_aireHabitaculoPasajeros:0,
        rt_aireHabitaculoPasajeros:0,
        rc_aireHabitaculoPasajeros:0,
        ev_aireHabitaculoPasajeros:0,
        observaciones_aireHabitaculoPasajeros:'',
    });
    ...
    useEffect(()=>{
        if(dataDictamen && dataDictamen.generales_motor && dataDictamen.generales_motor.motores_filtros){
            setDataForm({
                ...dataForm,
                ...dataDictamen.generales_motor.motores_filtros
            })
        }
    },[])
    ...
    const handleForm = (e: FormEvent<HTMLFormElement>) =>{
        ...
        firebaseInstance.guardarMotorFiltros()
    }
