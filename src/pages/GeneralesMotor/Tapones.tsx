...
const inputs = [
    {
        name:"",
        inputs:[
            {label:'Aceite', nameElement:'aceite'},
            {label:'Drenado de Aceite', nameElement:'drenadoAceite'},
            {label:'Combustible', nameElement:'combustible'},
            ...
            {label:'Dirección Hidraulica', nameElement:'direccionHidraulica'}
        ]
    }
...
const Tapones:React.FC = () =>{
    ...
    const [dataForm, setDataForm] = useState<FormData>({
        ...
        rc_drenadoAceite:0,
        ev_drenadoAceite:0,
        observaciones_drenadoAceite:'',
        au_combustible:0,
        or_combustible:0,
        rt_combustible:0,
        rc_combustible:0,
        ev_combustible:0,
        observaciones_combustible:'',
        ...
        au_direccionHidraulica:0,
        or_direccionHidraulica:0,
        rt_direccionHidraulica:0,
        rc_direccionHidraulica:0,
        ev_direccionHidraulica:0,
        observaciones_direccionHidraulica:'',
    });
    ...
    useEffect(()=>{
        if(dataDictamen && dataDictamen.generales_motor && dataDictamen.generales_motor.motores_tapones){
            setDataForm({
                ...dataForm,
                ...dataDictamen.generales_motor.motores_tapones
            })
        }
    },[])
    ...
    const handleForm = (e: FormEvent<HTMLFormElement>) =>{
        ...
        firebaseInstance.guardarMotorTapones()
    }
