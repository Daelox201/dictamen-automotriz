...
const data = [{
    ...
    nameForm:"Sistema Evaporativo", 
    nextSection:'', 
    prevSection:'Sistema de Inyección de Combustible', 
    nextRoute:'', 
    prevRoute:'sistemaInyeccionCombustible'
}]
...
const inputs = [
    {
        name:"",
        inputs:[
            {label:'Valvula de Purga', nameElement:'valvulaPurga'},
            {label:'Canister', nameElement:'canister'},
            {label:'Mangueras y Ducto', nameElement:'manguerasDuctos'},
...
const SistemaEvaporativo:React.FC = ()=>{
    ...
    const [dataForm, setDataForm] = useState({
        ...
        rc_valvulaPurga:0,
        ev_valvulaPurga:0,
        observaciones_valvulaPurga:'',
        au_canister:0,
        or_canister:0,
        rt_canister:0,
        rc_canister:0,
        ev_canister:0,
        observaciones_canister:'',
    ...
    useEffect(()=>{
        if(dataDictamen && dataDictamen.sistemas_motor && dataDictamen.sistemas_motor.sistema_evaporativo){
            setDataForm({
                ...dataForm,
                ...dataDictamen.sistemas_motor.sistema_evaporativo
            })
        }
    },[])
    ...
    const handleForm = (e: FormEvent<HTMLFormElement>) =>{
        ...
        firebaseInstance.guardarSistemaEvaporativo()
    }
...
export default SistemaEvaporativo;
