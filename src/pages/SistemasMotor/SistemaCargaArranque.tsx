...
const data = [
    {routeSection:"sistemasMotor", nameSection:"Sistemas Alternos de Motor", nameForm:"Sistema de Carga y Arranque", nextSection:'Sistema de Admision de Aire', prevSection:'', nextRoute:'sistemaAdmisionAire', prevRoute:''}
]

const inputs = [
    {name:"",
    inputs:[
        {label:'Bateria', nameElement:'bateria'},
        {label:'Alternador', nameElement:'alternador'},
        {label:'Protección de Circuitos', nameElement:'proteccionCircuitos'},
        {label:'Cableado y Conectores', nameElement:'cableadosConectores'},
        {label:'Conexiones E & E', nameElement:'conexionesEE'},
        {label:'Motor de Arranque', nameElement:'motorArranque'},
...
const SistemaCargaArranque:React.FC = () =>{

    const [dataForm, setDataForm] = useState<FormData>({

        select_bateria:"",
        select_alternador:"",
        select_proteccionCircuitos:"",
        select_cableadosConectores:"",
        select_conexionesEE:"",
        select_motorArranque:"",
        select_modulos:"",
        select_soportes:"",
        select_sujeciones:"",
        ...
        rc_alternador:0,
        ev_alternador:0,
        observaciones_alternador:'',
        au_proteccionCircuitos:0,
        or_proteccionCircuitos:0,
        rt_proteccionCircuitos:0,
        rc_proteccionCircuitos:0,
        ev_proteccionCircuitos:0,
        observaciones_proteccionCircuitos:'',
        ...
        rc_motorArranque:0,
        ev_motorArranque:0,
        observaciones_motorArranque:'',
        au_modulos:0,
        or_modulos:0,
        rt_modulos:0,
        rc_modulos:0,
        ev_modulos:0,
        observaciones_modulos:'',
        au_soportes:0,
        or_soportes:0,
        rt_soportes:0,
        rc_soportes:0,
    ...
    useEffect(()=>{
        if(dataDictamen && dataDictamen.sistemas_motor && dataDictamen.sistemas_motor.sistema_carga_arranque){
            setDataForm({
                ...dataForm,
                ...dataDictamen.sistemas_motor.sistema_carga_arranque
            })
        }
    },[])
    ...
    const handleForm = (e: FormEvent<HTMLFormElement>) =>{
        ...
        firebaseInstance.guardarSistemaCargaArranque()
    }
...
export default SistemaCargaArranque;
