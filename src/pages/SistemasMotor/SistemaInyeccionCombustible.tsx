...
const data = [{
    routeSection:"sistemasMotor", 
    nameSection:"Sistemas Alternos de Motor", 
    nameForm:"Sistemas de Inyección de Combustible", 
    nextSection:'Sistema Evaporativo', 
    prevSection:'Sistema de Encendido o Ignicion', 
    nextRoute:'sistemaEvaporativo', 
    prevRoute:'sistemaEncendidoIgnicion'
}]
...
const inputs = [
    {
        name:"",
        inputs:[
            {label:'Carburador', nameElement:'carburador'},
            {label:'Filtro de Combustible', nameElement:'filtroCombustible'},
            {label:'Tanque de Combustible', nameElement:'tanqueCombustible'},
            {label:'Bomba de combustible', nameElement:'bombaCombustible'},
            {label:'Mangueras y Ductos', nameElement:'mangueraDuctos'},
    ...
    {
        name:"Con Control Electroico",
        inputs:[
            {label:'Cuerpo de Aceleración', nameElement:'cuerpoAceleracion'},
            {label:'Inyectores', nameElement:'inyectores'}
        ]
    }
...
const SistemaInyeccionCombustible:React.FC = ()=>{

    const [dataForm, setDataForm] = useState({

        select_carburador:"",
        select_filtroCombustible:"",
        select_tanqueCombustible:"",
        select_bombaCombustible:"",
        select_mangueraDuctos:"",
        select_cableadosConectores:"",
        select_conexionesEE:"",
        select_fugas:"",
        select_sujeciones:"",
        select_cuerpoAceleracion:"",
        select_inyectores:"",
        select_soportes:"",
        ...
        rc_carburador:0,
        ev_carburador:0,
        observaciones_carburador:'',
        au_filtroCombustible:0,
        or_filtroCombustible:0,
        rt_filtroCombustible:0,
        rc_filtroCombustible:0,
        ev_filtroCombustible:0,
        observaciones_filtroCombustible:'',
        au_tanqueCombustible:0,
        or_tanqueCombustible:0,
        rt_tanqueCombustible:0,
        rc_tanqueCombustible:0,
        ev_tanqueCombustible:0,
        observaciones_tanqueCombustible:'',
        au_bombaCombustible:0,
        or_bombaCombustible:0,
        rt_bombaCombustible:0,
        rc_bombaCombustible:0,
        ev_bombaCombustible:0,
        observaciones_bombaCombustible:'',
        au_mangueraDuctos:0,
        or_mangueraDuctos:0,
        rt_mangueraDuctos:0,
        rc_mangueraDuctos:0,
        ev_mangueraDuctos:0,
        observaciones_mangueraDuctos:'',
        ...
        au_cuerpoAceleracion:0,
        or_cuerpoAceleracion:0,
        rt_cuerpoAceleracion:0,
        rc_cuerpoAceleracion:0,
        ev_cuerpoAceleracion:0,
        observaciones_cuerpoAceleracion:'',
        au_inyectores:0,
        or_inyectores:0,
        rt_inyectores:0,
        rc_inyectores:0,
        ev_inyectores:0,
        observaciones_inyectores:'',
        au_soportes:0,
        or_soportes:0,
        rt_soportes:0,
        rc_soportes:0,
    ...
    useEffect(()=>{
        if(dataDictamen && dataDictamen.sistemas_motor && dataDictamen.sistemas_motor.sistema_inyeccion_combustible){
            setDataForm({
                ...dataForm,
                ...dataDictamen.sistemas_motor.sistema_inyeccion_combustible
            })
        }
    },[])
    ...
    const handleForm = (e: FormEvent<HTMLFormElement>) =>{
        ...
        firebaseInstance.guardarSistemaInyeccionCombustible()
    }
...
export default SistemaInyeccionCombustible;
