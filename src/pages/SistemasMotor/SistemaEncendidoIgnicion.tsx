...
const data = [
    {routeSection:"sistemasMotor", nameSection:"Sistemas Alternos de Motor", nameForm:"Sistema de Encendido o Ignicion", nextSection:'Sistema de Inyección de Combustible', prevSection:'Sistema de Enfriamento', nextRoute:'sistemaInyeccionCombustible', prevRoute:'sistemaEnfriamento'}
]
...
const inputs = [
    {
        name:"",
        inputs:[
            {label:'Interruptor de Encendido (Switch)', nameElement:'interruptorEncendido'},
            {label:'Distribuidor', nameElement:'distribuido'},
            {label:'Cables Bujias (Circuito Secundario)', nameElement:'cablesBujias'},
            {label:'Cables Alimentación (Circuito Primario)', nameElement:'cablesAlimentacionn'},
            {label:'Cableados y Conectores', nameElement:'cableadosConectores'},
            {label:'ConexionesEE', nameElement:'conexionesEE'},
            {label:'Bobinas', nameElement:'bobinas'},
    ...
    },
    {
        ...
        inputs:[
            {label:'Modulo DIS', nameElement:'moduloDis'},
            {label:'Bobinas Independientes', nameElement:'bobinasIndependientes'}
        ]
    }
]


const SistemaEncendidoIgnicion:React.FC = () =>{

    const [dataForm, setDataForm] = useState({

        select_interruptorEncendido:"",
        select_distribuido:"",
        select_cablesBujias:"",
        select_cablesAlimentacionn:"",
        ...
        au_interruptorEncendido:0,
        or_interruptorEncendido:0,
        rt_interruptorEncendido:0,
        rc_interruptorEncendido:0,
        ev_interruptorEncendido:0,
        observaciones_interruptorEncendido:'',
        au_distribuido:0,
        or_distribuido:0,
        rt_distribuido:0,
        rc_distribuido:0,
        ev_distribuido:0,
        observaciones_distribuido:'',
        au_cablesBujias:0,
        or_cablesBujias:0,
        rt_cablesBujias:0,
        rc_cablesBujias:0,
        ev_cablesBujias:0,
        observaciones_cablesBujias:'',
        au_cablesAlimentacionn:0,
        or_cablesAlimentacionn:0,
        rt_cablesAlimentacionn:0,
        rc_cablesAlimentacionn:0,
        ev_cablesAlimentacionn:0,
        observaciones_cablesAlimentacionn:'',
        ...
        au_bobinasIndependientes:0,
        or_bobinasIndependientes:0,
        rt_bobinasIndependientes:0,
        rc_bobinasIndependientes:0,
        ev_bobinasIndependientes:0,
        observaciones_bobinasIndependientes:'',
        au_soportes:0,
        or_soportes:0,
        rt_soportes:0,
        rc_soportes:0,
    ...
    useEffect(()=>{
        if(dataDictamen && dataDictamen.sistemas_motor && dataDictamen.sistemas_motor.sistema_encendido_ignicion){
            setDataForm({
                ...dataForm,
                ...dataDictamen.sistemas_motor.sistema_encendido_ignicion
            })
        }
    },[])
    ...
    const handleForm = (e: FormEvent<HTMLFormElement>) =>{
        ...
        firebaseInstance.guardarSistemaEncendidoIgnicion()
    }
...
export default SistemaEncendidoIgnicion;
