  ...
  return (
    ...
    <Document>
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.logoHidalgo}>
          <Image src="src/img/logo Hidalgo 2022-2028(2).png" style={styles.logo} />
        </View>
        <View style={styles.logoUpp}>
          <Image src="src/img/logo UPP.png" style={styles.logo} />
        </View>
