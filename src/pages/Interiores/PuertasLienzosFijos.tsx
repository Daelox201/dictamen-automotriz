...
const data = [
  {
    ...
    nameForm: "Puertas y/o Lienzos Fijos",
    nextSection: "Domo Trasero y/o Cajuela",
    prevSection: "Tablero",
    nextRoute: "domoTraseroCajuela",
    prevRoute: "tablero",
  },
];
...
const inputs = [
  {
    ...
    inputs:[
      ...
      { label: "Elevadores", nameElement: "elevadores" },
      { label: "Almacenaje", nameElement: "almacenaje" },
      { label: "Control Espejos", nameElement: "controlEspejos" },
...
const PuertasLienzosFijos: React.FC = () => {
  ...
  useEffect(()=>{
    if(dataDictamen && dataDictamen.interiores && dataDictamen.interiores.interiores_puertas_lienzos_fijos){
        setDataForm({
            ...dataForm,
            ...dataDictamen.interiores.interiores_puertas_lienzos_fijos
        })
    }
},[])
...
const handleInputSelect = (e: CustomEvent<InputChangeEventDetail>)=>{
  ...
  const handleForm = (e: FormEvent<HTMLFormElement>) =>{
      ...
      firebaseInstance.guardarInterioresPuertasLienzosFijos()
  }
...
export default PuertasLienzosFijos;
