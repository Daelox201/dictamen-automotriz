...
const inputs = [
  {
    ...
    inputs:[
      ...
      { label: "Piloto", nameElement: "piloto" },
      { label: "Co-piloto", nameElement: "copiloto" },
      { label: "Butaca Intermedia", nameElement: "butacaIntermedia" },
      { label: "Butaca Trasera", nameElement: "butacaTrasera" },
      { label: "Reposabrazos", nameElement: "reposabrazos" },
      { label: "Cabeceras", nameElement: "cabeceras" },
      { label: "Control de Asientos", nameElement: "controlAsientos" },
...
const Asientos: React.FC = () => {
  const [dataForm, setDataForm] = useState<FormData>({
    ...
    select_piloto:"",
    select_copiloto:"",
    select_butacaIntermedia:"",
    select_butacaTrasera:"",
    select_reposabrazos:"",
    select_cabeceras:"",
    select_controlAsientos:"",
    select_molduras:"",
    select_sujeciones:"",
    ...
    rc_piloto: "0",
    ev_piloto: "0",
    observaciones_piloto: "",
    au_copiloto: "0",
    or_copiloto: "0",
    rt_copiloto: "0",
    rc_copiloto: "0",
    ev_copiloto: "0",
    observaciones_copiloto: "",
    au_butacaIntermedia: "0",
    or_butacaIntermedia: "0",
    rt_butacaIntermedia: "0",
    rc_butacaIntermedia: "0",
    ev_butacaIntermedia: "0",
    observaciones_butacaIntermedia: "",
    au_butacaTrasera: "0",
    or_butacaTrasera: "0",
    rt_butacaTrasera: "0",
    rc_butacaTrasera: "0",
    ev_butacaTrasera: "0",
    observaciones_butacaTrasera: "",
    au_reposabrazos: "0",
    or_reposabrazos: "0",
    rt_reposabrazos: "0",
    rc_reposabrazos: "0",
    ev_reposabrazos: "0",
    observaciones_reposabrazos: "",
    au_cabeceras: "0",
    or_cabeceras: "0",
    rt_cabeceras: "0",
    rc_cabeceras: "0",
    ev_cabeceras: "0",
    observaciones_cabeceras: "",
    au_controlAsientos: "0",
    or_controlAsientos: "0",
    rt_controlAsientos: "0",
    rc_controlAsientos: "0",
    ev_controlAsientos: "0",
    observaciones_controlAsientos: "",
    au_molduras: "0",
    or_molduras: "0",
    rt_molduras: "0",
    rc_molduras: "0",
  ...
  const { dataDictamen } = useContext(MyContext);
    ...
    useEffect(()=>{
        if(dataDictamen && dataDictamen.interiores && dataDictamen.interiores.interiores_asientos){
            setDataForm({
                ...dataForm,
                ...dataDictamen.interiores.interiores_asientos
            })
        }
    },[])
...
const handleInputSelect = (e: CustomEvent<InputChangeEventDetail>)=>{
  ...
  const handleForm = (e: FormEvent<HTMLFormElement>) =>{
      ...
      firebaseInstance.guardarInterioresAsientos()
  }
