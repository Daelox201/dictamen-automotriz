...
const data = [
  {
    ...
    nameForm: "Tablero",
    nextSection: "Puertas y/o Lienzos Fijos",
    prevSection: "Asientos",
    nextRoute: "puertasLienzosFijos",
    prevRoute: "asientos",
  },
];
...
const inputs = [
  {
    ...
    inputs:[
      ...
      { label: "Interruptores", nameElement: "interruptores" },
      { label: "Panel Instrumentos", nameElement: "panelInstrumentos" },
      { label: "Volante de Dirección", nameElement: "volanteDireccion" },
      { label: "Placas de Control", nameElement: "placasControl" },
      { label: "Control de Crucero", nameElement: "controlCrucero" },
      { label: "Bocina o Claxon", nameElement: "bocina" },
      { label: "Bolsa de Aire (Volante)", nameElement: "bolsaAireVolante" },
      { label: "Radio o Sistema de Entretenimiento", nameElement: "radio" },
      { label: "Rejillas A/A", nameElement: "rejillasAA" },
      { label: "Controles A/A", nameElement: "controlesAA" },
      { label: "Consola Central", nameElement: "consolaCentral" },
      { label: "Bolsa de Aire (Copiloto)", nameElement: "bolsaAireCopiloto" },
      { label: "Guantera", nameElement: "guantera" },
      { label: "Almacenaje", nameElement: "almacenaje" },
...
const Tablero: React.FC = () => {
  const [dataForm, setDataForm] = useState<FormData>({
    ...
    select_estado:"",
    select_interruptores:"",
    select_panelInstrumentos:"",
    select_volanteDireccion:"",
    select_placasControl:"",
    select_controlCrucero:"",
    select_bocina:"",
    select_bolsaAireVolante:"",
    select_radio:"",
    select_rejillasAA:"",
    select_controlesAA:"",
    select_consolaCentral:"",
    select_bolsaAireCopiloto:"",
    select_guantera:"",
    select_molduras:"",
    select_sujeciones:"",
    ...
    au_panelInstrumentos: "0",
    or_panelInstrumentos: "0",
    rt_panelInstrumentos: "0",
    rc_panelInstrumentos: "0",
    ev_panelInstrumentos: "0",
    observaciones_panelInstrumentos: "",
    au_volanteDireccion: "0",
    or_volanteDireccion: "0",
    rt_volanteDireccion: "0",
    rc_volanteDireccion: "0",
    ev_volanteDireccion: "0",
    observaciones_volanteDireccion: "",
    au_placasControl: "0",
    or_placasControl: "0",
    rt_placasControl: "0",
    rc_placasControl: "0",
    ev_placasControl: "0",
    observaciones_placasControl: "",
    au_controlCrucero: "0",
    or_controlCrucero: "0",
    rt_controlCrucero: "0",
    rc_controlCrucero: "0",
    ev_controlCrucero: "0",
    observaciones_controlCrucero: "",
    au_bocina: "0",
    or_bocina: "0",
    rt_bocina: "0",
    rc_bocina: "0",
    ev_bocina: "0",
    observaciones_bocina: "",
    au_bolsaAireVolante: "0",
    or_bolsaAireVolante: "0",
    rt_bolsaAireVolante: "0",
    rc_bolsaAireVolante: "0",
    ev_bolsaAireVolante: "0",
    observaciones_bolsaAireVolante: "",
    au_radio: "0",
    or_radio: "0",
    rt_radio: "0",
    rc_radio: "0",
    ...
    rc_rejillasAA: "0",
    ev_rejillasAA: "0",
    observaciones_rejillasAA: "",
    au_controlesAA: "0",
    or_controlesAA: "0",
    rt_controlesAA: "0",
    rc_controlesAA: "0",
    ev_controlesAA: "0",
    observaciones_controlesAA: "",
    au_consolaCentral: "0",
    or_consolaCentral: "0",
    rt_consolaCentral: "0",
    rc_consolaCentral: "0",
    ev_consolaCentral: "0",
    observaciones_consolaCentral: "",
    au_bolsaAireCopiloto: "0",
    or_bolsaAireCopiloto: "0",
    rt_bolsaAireCopiloto: "0",
    rc_bolsaAireCopiloto: "0",
    ev_bolsaAireCopiloto: "0",
    observaciones_bolsaAireCopiloto: "",
    au_guantera: "0",
    or_guantera: "0",
    rt_guantera: "0",
    rc_guantera: "0",
    ev_guantera: "0",
    observaciones_guantera: " ",
  ...
  useEffect(()=>{
    if(dataDictamen && dataDictamen.interiores && dataDictamen.interiores.interiores_tablero){
        setDataForm({
            ...dataForm,
            ...dataDictamen.interiores.interiores_tablero
        })
    }
},[])
...
const handleInputSelect = (e: CustomEvent<InputChangeEventDetail>)=>{
  ...
  const handleForm = (e: FormEvent<HTMLFormElement>) =>{
      ...
      firebaseInstance.guardarInterioresTablero()
  }
