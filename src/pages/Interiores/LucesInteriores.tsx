...
const data = [
  {
    ...
    nameForm: "Luces Interiores",
    nextSection: "Tapicerias y Alfombrados",
    prevSection: "Domo Trasero y/o Cajuela ",
    nextRoute: "tapiceriasAlfombrados",
    prevRoute: "domoTraseroCajuela",
  },
];
...
const inputs = [
  {
    name:"",
    inputs:[
      { label: "Estado Unidades", nameElement: "estado" },
...
const LucesInteriores: React.FC = () => {
  ...
  useEffect(()=>{
    if(dataDictamen && dataDictamen.interiores && dataDictamen.interiores.interiores_luces_interiores){
        setDataForm({
            ...dataForm,
            ...dataDictamen.interiores.interiores_luces_interiores
        })
    }
},[])
...
const handleInputSelect = (e: CustomEvent<InputChangeEventDetail>)=>{
  ...
  const handleForm = (e: FormEvent<HTMLFormElement>) =>{
      ...
      firebaseInstance.guardarInterioresLucesInteriores()
  }
...
export default LucesInteriores;
