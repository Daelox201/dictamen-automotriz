...
const data = [
  {
    ...
    nameForm: "Molduras",
    nextSection: "Luces",
    prevSection: "Accesorios",
    nextRoute: "luces",
    prevRoute: "accesorios",
  },
];
...
const inputs = [
  {
    name:"",
    inputs:[
      { label: "Completas", nameElement: "completas" },
      { label: "Acabados y Terminados", nameElement: "acabadosTerminados" },
...
const Molduras: React.FC = () => {
  const [dataForm, setDataForm] = useState<FormData>({
    ...
    au_acabadosTerminados: "0",
    or_acabadosTerminados: "0",
    rt_acabadosTerminados: "0",
    rc_acabadosTerminados: "0",
    ev_acabadosTerminados: "0",
    observaciones_acabadosTerminados: " ",
  ...
  useEffect(()=>{
    if(dataDictamen && dataDictamen.carroceria && dataDictamen.carroceria.carroceria_molduras){
        setDataForm({
            ...dataForm,
            ...dataDictamen.carroceria.carroceria_molduras
        })
    }
},[])
...
const handleInputSelect = (e: CustomEvent<InputChangeEventDetail>)=>{
  ...
  const handleForm = (e: FormEvent<HTMLFormElement>) =>{
      ...
      firebaseInstance.guardarCarroceriaMolduras()
  }
