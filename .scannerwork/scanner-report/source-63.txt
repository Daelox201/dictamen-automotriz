...
const data = [
  {
    ...
    nameForm: "Tapicerias y Alfombrados",
    nextSection: "",
    prevSection: "Luces Interiores",
    nextRoute: "",
    prevRoute: "lucesInteriores",
  },
];
...
const TapiceriasAlfombrados: React.FC = () => {
  ...
  useEffect(()=>{
    if(dataDictamen && dataDictamen.interiores && dataDictamen.interiores.interiores_tapicerias_alfombrados){
        setDataForm({
            ...dataForm,
            ...dataDictamen.interiores.interiores_tapicerias_alfombrados
        })
    }
},[])
...
const handleInputSelect = (e: CustomEvent<InputChangeEventDetail>)=>{
  ...
  const handleForm = (e: FormEvent<HTMLFormElement>) =>{
      ...
      firebaseInstance.guardarInterioresTapiceriasAlfombrados()
  }
...
export default TapiceriasAlfombrados;
